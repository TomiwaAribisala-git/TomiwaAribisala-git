...
## My Skills
[![My Skills](https://skillicons.dev/icons?i=linux,docker,kubernetes,python,golang,html,css,js,aws,gcp,jenkins,githubactions,gitlab,ansible,prometheus,bash,git,terraform,gitlab,terragrunt,jira)](https://skillicons.dev)
